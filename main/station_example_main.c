...
float *temperature_p, *humidity_p;

static sht3x_t dev;

// https://maker.ifttt.com/trigger/temp_hum/with/key/fvdRJTHeWVxGxs-0Erew6Y__Bj2LwdrxBBAOaFKjnFK
// const *char resource = "/trigger/temp_hum/with/key/fvdRJTHeWVxGxs-0Erew6Y__Bj2LwdrxBBAOaFKjnFK";
...
esp_err_t _http_event_handler(esp_http_client_event_t *evt)
{
    ...
    case HTTP_EVENT_ON_FINISH:
        ...
        ESP_LOGI("ITTT", "Received data: %s", response_data);
        break;
    default:
        break;
    }
...
void sht_task(void *pvParameters)
{
    float temperature;
    float humidity;
...
void app_main(void)
{
    ...
    xTaskCreatePinnedToCore(sht_task, "sh301x_test", configMINIMAL_STACK_SIZE * 8, NULL, 5, NULL, APP_CPU_NUM);

    
//"https://maker.ifttt.com/trigger/temp_hum/with/key/fvdRJTHeWVxGxs-0Erew6Y__Bj2LwdrxBBAOaFKjnFK"
    const char *json_data = "{ \"value1\" : \"%.2f\", \"value2\" : \"%.2f\"}";
    esp_http_client_config_t http_config = {
        .url = CONFIG_IFTTT_URL,
    ...
    while (counter-- > 0)
    {
        ...
        sprintf(str, json_data, *temperature_p, *humidity_p);
        ...
        // Clean up the HTTP client handle
